...
#define SX_ANT                    IO_P10  // 天线选择引脚
#define SX_USE_LP_PA                      // 使用低功率放大器 (针对 900MHz 频段)
#define SX_USE_RFSW_CTRL          {31, 0, 4, 24, 24, 0, 0, 0}  // 射频开关控制配置
...
void sx_init_gpio(void)
{
    ...
    gpio_init(SX_ANT, IO_MODE_OUTPUT_PP_HIGH);  // 强制使用天线2，与按钮一致
}
...
#define RFPOWER_DEFAULT 3      // 默认射频功率 (dBm)
